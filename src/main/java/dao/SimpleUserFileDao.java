 ...
 */
public class SimpleUserFileDao implements UserFileDao,AutoCloseable {
    private ConnectionUtil connectionUtil;
    private PropertiesHandler propertiesHandler;
    private Connection con;
    @Autowired
    public SimpleUserFileDao(ConnectionUtil connectionUtil, PropertiesHandler propertiesHandler) {
        this.connectionUtil = connectionUtil;
        this.propertiesHandler = propertiesHandler;
        this.con = connectionUtil.getConnection(propertiesHandler.getDATABASENAME());
    }

    private final Logger LOG = LoggerFactory.getLogger(SimpleUserFileDao.class);
